...
class Password_hasher {
    ...
    /////// END password_needs_rehash function
    ...
    public function _encode_arr ($arr) {
        return base64_encode(serialize($arr));
    }

    public function _decode_arr ($arr) {
